Guia de Contribuição - Frontend Conecta+Saúde Ficamos felizes com seu interesse em contribuir! Para manter o projeto organizado, por favor, siga estas diretrizes.

💬 Fluxo de Trabalho com Pull Requests Todo o desenvolvimento deve ser feito em branches separadas e integrado através de Pull Requests (PRs) para a branch develop.
...
feature/: Para novas funcionalidades (ex: feature/adicionar-tela).

fix/: Para correções de bugs (ex: fix/corrigir-responsividade).

git checkout -b feature/nome-da-sua-feature

Faça seus Commits: Adicione suas alterações e faça commits com mensagens claras e descritivas.

git add . git commit -m "feat: Adiciona responsividade a tela de login"
